...
| -------------- | ----------------------------------------------- |
| `/briefing`    | Shows time window buttons (3h / 6h / 12h / 24h) |
| `/briefing 6`  | Top coins from last 6 hours                     |
| `/briefing 12` | Top coins from last 12 hours                    |
| `/status`      | Shows how many coins are tracked per source     |
| `/help`        | Shows all commands                              |

### Example output

```
🔍 Briefing — Last 6h (5 coins)
━━━━━━━━━━━━━━━━━━━━━━━━━━━

1. ◎ PepeCoin $PEPE
   💬 Mentions: 14x 📱 🎮
   📊 Vol 24h: $2.3M | MC: $8.1M
   🟢 Price: $0.000042 (+134.5%)
   📋 7xKf3m...9dR2pQ
   🔗 Chart

2. Ξ WojakETH $WOJAK
   💬 Mentions: 8x 📱
   📊 Vol 24h: $890K | MC: $3.2M
   🔴 Price: $0.00081 (-12.3%)
   📋 0x4a2f...8c91
   🔗 Chart
...
